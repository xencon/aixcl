...
> Vendored copy of Anthropic's skill-authoring best-practices guide
> (docs.claude.com, retrieved 2026-07), converted to ASCII with web links
> stripped for offline use. File paths and skill examples inside this guide
> are illustrative, not references to files in this repository.

## Contents

- Core principles (conciseness, degrees of freedom, testing)
- Skill structure (naming, descriptions, progressive disclosure, nested references)
- Workflows and feedback loops
- Content guidelines (time-sensitive info, terminology)
- Common patterns (templates, examples, conditional workflows)
- Evaluation and iteration
- Anti-patterns to avoid
- Advanced: Skills with executable code (error handling, scripts, dependencies, MCP tools)
...
Full source from: https://platform.claude.com/docs/en/agents-and-tools/agent-skills/best-practices
