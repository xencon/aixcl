...
1. Loads the template file from `.github/ISSUE_TEMPLATE/` first (`cat .github/ISSUE_TEMPLATE/task.md` for tasks, `bug_report.md` for bugs, `feature_request.md` for features)
...
This will:
- Read `.github/ISSUE_TEMPLATE/feature_request.md` first
