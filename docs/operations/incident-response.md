...
- [ ] Compromised container stopped via `./aixcl stack stop <service>`
...
Approve: `./aixcl security approve <request-id>`
Deny: `./aixcl security deny <request-id>`
```
...
| Human approvals | Manage approval queue | `./aixcl security list-approvals` |
