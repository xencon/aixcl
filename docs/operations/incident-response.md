...
- [ ] Run manual control checks from [compensating-controls.md](../security/compensating-controls.md)
...
# Verify all controls (run checks from compensating-controls.md)
./aixcl stack status
...
| Chain verify | Verify audit integrity | `psql` audit gap query (see compensating-controls.md) |
