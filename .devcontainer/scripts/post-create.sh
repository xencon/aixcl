...
echo ""
echo "Dev Container Notes:"
echo "  Run '.devcontainer/scripts/pre-start.sh' before first AIXCL start"
echo "  This fixes Docker-in-Docker entrypoint mounting issues"
echo ""
echo "OpenCode (AI Assistant):"
echo "  opencode                             # Start OpenCode CLI"
echo "  opencode --provider aixcl-local      # Use AIXCL inference"
echo ""
